// jobapplier.upstream.domUtils — AGPL-3.0 subtree (see LICENSE).
// SPDX-License-Identifier: AGPL-3.0-only
//
// Byte-verbatim fork of Skyvern @ 28db09cb
//   (skyvern/webeye/scraper/domUtils.js). Page-injected browser JS with no
//   Python coupling. Trims: none — SPDX/provenance header comment prepended,
//   the file body below is unchanged.
